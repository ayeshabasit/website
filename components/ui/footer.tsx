...
export default function Footer() {
  return (
    <footer>
      <div className="py-12 mt-6 md:py-16 bg-athenix-dark-green">
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            {/* <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
              <li>
                <Link
                  href="/"
                  className="flex justify-center items-center text-athenix-light-green bg-gray-800 hover:text-athenix-white hover:bg-black rounded-full transition duration-150 ease-in-out"
                  aria-label="Twitter"
                >
                  <svg
            ...
            <div className="text-gray-400 text-sm mr-4">
              &copy; Athenix.co. All rights reserved.
            </div>
          </div>
        </div>
      </div>
